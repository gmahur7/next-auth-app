        ...
        items-center px-4 sm:px-32 py-4'>
                ...
                <div>
                    <ul className='flex gap-2 sm:gap-16'>
                        ...
                        <li className={`${path==='/profile'||path==='/signup'&&' text-blue-600 border-b-2 border-blue-400 pb-2'} hover:text-blue-400 text-sm sm:text-md`}><Link href={data?"/profile":"/signup"}>{data?`Profile`:"Sign Up"}</Link></li>
                        <li className={`${path==='/login'||path==='/logout'&&'border-b-2 border-blue-400'} hover:text-blue-400 text-sm sm:text-md`}><Link href={data?"#":"/login"} onClick={handler}>{data?`Logout`:"Login"}</Link></li>
